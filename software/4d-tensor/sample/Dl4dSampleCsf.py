    ...
    def tns_sample(self, tns_dir):
        ...
        for line in tnsfile:
            ...
            if len(tns_seg) < 5:
                ...
                lastdim = [int(int(tns_seg[-5])-1), int(int(tns_seg[-4])-1), int(int(tns_seg[-3])-1)]
                break
        ...
        for line in tnsfile:
            ...
            if len(tns_seg) < 5:
                continue
            valdim = [int(int(tns_seg[-5])-1), int(int(tns_seg[-4])-1), int(int(tns_seg[-3])-1)]
            if valdim[0] == lastdim[0] and valdim[1] == lastdim[1]:
                tmpnnzPerSlice += 1
