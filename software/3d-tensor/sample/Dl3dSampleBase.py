...
class gbt3dSample(object):
    ...
    def tns_sample(self, tns_dir):
        ...
        ftset.max_nnz = [dim0_nnz[0], dim1_nnz[0], dim2_nnz[0]]
        ftset.min_nnz = [dim0_nnz[0], dim1_nnz[0], dim2_nnz[0]]
        ftset.ave_nnz = [dim0_nnz[0], dim1_nnz[0], dim2_nnz[0]]
        ftset.dev_nnz = [dim0_nnz[0], dim1_nnz[0], dim2_nnz[0]]
        ftset.bounce = [dim0_nnz[0], dim1_nnz[0], dim2_nnz[0]]

        tot_nnz = [dim0_nnz[0], dim1_nnz[0], dim2_nnz[0]]
        dim_counter = [compare(dim0_nnz[0],0), compare(dim1_nnz[0],0), compare(dim2_nnz[0],0)]
        adj_nnz = [0, 0, 0]
    ...
    def tns_batch(self, tensorlist, ftlist):
        ...
        for findex in range(0, batch_size):
            ...
            ftdata.write('{},{},{}'.format(str(labels[findex][0]), str(labels[findex][1]), str(labels[findex][2])))
